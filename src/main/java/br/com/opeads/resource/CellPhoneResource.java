...
public class CellPhoneResource {
	...
	@RequestMapping(value = "/cliente/{cliente}/contato/{id}/save/celular",method = RequestMethod.POST, consumes = {MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<Void> create(@PathVariable("id") Long id, @PathVariable("cliente") Long cliente,@RequestBody CellPhone cellPhone){
	...
	/*@RequestMapping(value = "/cliente/contato/edit/celular",method = RequestMethod.PUT, consumes = {MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<Void> update(@RequestBody CellPhone cellPhone){
	...
	public ResponseEntity<Void> delete(@RequestBody CellPhone contact){
		cellPhoneService.delete(contact);
	...
	public ResponseEntity<CellPhone> get(@PathVariable("id") CellPhone contact){
		return ResponseEntity.ok().body(cellPhoneService.findById(contact));
	}
}
