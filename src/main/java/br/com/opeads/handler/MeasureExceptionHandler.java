...
public class MeasureExceptionHandler {
	...
	@ExceptionHandler(MeasureDoesNotExistsException.class)
	public ResponseEntity<?> handlerMedidaNaoExisteException(MeasureDoesNotExistsException e,HttpServletRequest request){
	...
	@ExceptionHandler(MeasureAlreadyExistsException.class)
	public ResponseEntity<?> handlerMedidaJaExisteException(MeasureAlreadyExistsException e, HttpServletRequest request){
		Error erro = new Error();
		erro.setStatus(409L);
		erro.setTitle(e.getMessage());
