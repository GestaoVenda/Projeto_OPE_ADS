...
import br.com.opeads.Exception.ContatoNaoExisteException;
...
public class ContatoExceptionHandler {
	...
	public ResponseEntity<?> handlerContatoNaoExisteException(ContatoNaoExisteException e,HttpServletRequest request){
	...
	public ResponseEntity<?> handlerContatoJaExisteException(ContatoJaExisteException e, HttpServletRequest request){
		Error erro = new Error();
		erro.setStatus(409L);
		erro.setTitle(e.getMessage());
