...
@ControllerAdvice
public class MedidaExceptionHandler {

	@ExceptionHandler(MedidaNaoExisteException.class)
	public ResponseEntity<?> handlerMedidaNaoExisteException(MedidaNaoExisteException e,HttpServletRequest request){
	...
	@ExceptionHandler(MedidaJaExisteException.class)
	public ResponseEntity<?> handlerMedidaJaExisteException(MedidaJaExisteException e, HttpServletRequest request){
		Error erro = new Error();
		erro.setStatus(409L);
		erro.setTitle(e.getMessage());
