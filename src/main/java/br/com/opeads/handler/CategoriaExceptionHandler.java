...
public class CategoriaExceptionHandler {
	...
	public ResponseEntity<?> handlerCategoriaNaoExisteException(CategoriaNaoExisteException e,HttpServletRequest request){
	...
	public ResponseEntity<?> handlerCategoriaJaExisteException(CategoriaJaExisteException e, HttpServletRequest request){
		Error erro = new Error();
		erro.setStatus(409L);
		erro.setTitle(e.getMessage());
